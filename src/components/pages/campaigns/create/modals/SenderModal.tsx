...
export function SenderModal({
	...
	const [senderName, setSenderName] = useState('Bright Side Car Wash');
	const [senderEmail, setSenderEmail] = useState('hello@brightsidecarwash.com');
	const [starred, setStarred] = useState(false);

	const avatarBg = '#A0887E';
	const firstLetter = senderName.trim().charAt(0).toUpperCase() || 'B';
