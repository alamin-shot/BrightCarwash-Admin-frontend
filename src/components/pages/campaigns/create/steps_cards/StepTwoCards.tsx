...
export function StepTwoCards({ filled, onToggle, campaignName, onDesignClick, selectedTemplateName }: StepTwoCardsProps) {
						...
						<div className="flex items-start gap-3">
							...
							<div className="flex flex-col items-start gap-1">
								...
								<span className="text-[#777980] font-inter text-sm font-normal leading-[132%]">
									{card.key === "design" && filled.design && selectedTemplateName
