  ...
  return (
    <div className="flex w-full p-3 flex-col items-start gap-3 rounded-lg border border-[#DFE1E7] bg-white adm-kanban-card">
      <div className="flex justify-between items-center self-stretch">
        ...
        <ActionsDropdown
          items={[
            { label: "View details", onClick: () => toast.info(`Viewing ${lead.name}`) },
            { label: "Delete", onClick: () => toast.info(`Delete ${lead.name}`) },
          ]}
        />
      </div>
      ...
      <div className="flex justify-between items-center self-stretch">
        ...
        <Button variant="icon" className="flex p-1.5 items-center gap-3 rounded border border-[#DFE1E7] bg-white cursor-pointer">
