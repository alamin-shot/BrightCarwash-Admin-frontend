            ...
            {(provided) => (
                ...
                >
                    ...
                    <div className="flex-1 p-4 flex flex-col gap-1 border-r border-[#E8E8E9] min-w-0">
                        ...
                        <span className="text-sm text-[#777980] truncate">
                            {faq.answer}
                        </span>
                    </div>
                    ...
                    <div className="flex p-3 items-center gap-3 self-stretch border-r border-[#E8E8E9] w-[120px] shrink-0">
                        <span
                            className={`inline-flex py-1 px-3 justify-center items-center rounded-full text-xs font-medium ${faq.is_active
                    ...
                    {/* Actions Cell - Fixed width with proper button sizing */}
                    <div className="flex p-3 justify-center items-center gap-2 self-stretch w-[88px] shrink-0">
                        {/* Edit Button - 40x40 with 6px padding = 28x28 icon area */}
                        <button
                            onClick={() => onEdit(faq)}
