    ...
    <header className="flex w-full h-[72px] px-3 sm:px-4 lg:px-6 py-5 justify-between items-center border-b border-[#DFE1E7] bg-white sticky top-0 z-30">
      ...
      <div className="flex items-center gap-1 sm:gap-2 shrink-0">
        <Button
          ...
          aria-label="Search"
        >
          <Icon name="search" width={20} height={20} className="lg:w-6 lg:h-6" />
        </Button>
        ...
        <div className="flex py-1.5 px-1.5 lg:py-[6px] lg:px-[6px] items-center gap-2 lg:gap-4 rounded-lg border border-[#E8E8E9] bg-white">
          <div className="flex items-center gap-2">
            ...
            <span className="hidden lg:block text-[#1F274B] font-inter text-xs font-normal leading-[100%] truncate max-w-[100px]">
              {user?.name || "User"}
            </span>
          </div>
        </div>
